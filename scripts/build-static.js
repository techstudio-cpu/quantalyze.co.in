...
console.log('🚀 Building Static Site for ServerByt...\n');
...
console.log('2️⃣ Preparing static build config...');
...
// Step 3: Temporarily move API and admin folders (they can't be statically exported)
console.log('3️⃣ Temporarily excluding API and admin routes...');
...
if (fs.existsSync(nextOutDir)) {
  ...
  console.error('❌ No output directory found. Make sure next.config.static.js has output: "export"');
  process.exit(1);
}

// Step 6: Clean up any admin pages that may have been exported
console.log('6️⃣ Verifying no admin pages in output...');
const adminOutDir = path.join(OUT_DIR, 'admin');
if (fs.existsSync(adminOutDir)) {
  fs.rmSync(adminOutDir, { recursive: true, force: true });
  console.log('   ✓ Removed /admin directory');
} else {
  console.log('   ✓ No admin pages in output (correct)');
}

// Step 7: Create .htaccess for Apache
console.log('7️⃣ Creating .htaccess for Apache...');
...
console.log('8️⃣ Creating deployment info...');
const deployInfo = {
...
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
console.log('📁 Output folder: static-deploy/');
console.log('🌐 Static site:   https://quantalyze.co.in');
console.log('🔧 Admin panel:   ' + RAILWAY_API + '/admin');
console.log('📡 API endpoint:  ' + RAILWAY_API + '/api');
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
console.log('\n📤 Upload contents of static-deploy/ to ServerByt public_html');
